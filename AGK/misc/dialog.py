...
class dialog(object):
	def __init__(self, text, type=None, popup_sound=None, SAPI=False):
		self.text=text
		self.type=type
...
class EntryDialog(object):
	def __init__(self, displaytext, type_sound=None, speak_chars=False, SAPI=False):
		self.displaytext=displaytext
		self.speak_chars=speak_chars
		self.type_sound=type_sound
		self.SAPI=SAPI
		self.string=""
		if self.type_sound:
